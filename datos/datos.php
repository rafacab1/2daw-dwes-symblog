...
$comment1->setComment('To make a long story short. You can\'t go wrong by choosing Sym-fony! And no one has ever been fired for using Symfony.');
$comment1->setBlog($blog1);
$comment2 = new Comment();
$comment2->setUser('David');
$comment2->setComment('To make a long story short. Choosing a frame-work must not be taken lightly; it is a long-term commitment. Make sure that you make the right se-lection!');
...
$blog2->setBlog('Vestibulum vulputate mauris eget erat congue dapibus imperdiet justo sceleris-que. Na. Cras elementum molestie vestibulum. Morbi id quam nisl. Praesent hendrerit, orci sed elemen-tum lobortis.'); 
...
$comment3->setComment('Anything else, mom? You want me to mow the lawn? Oops! I for-got, New York, No grass.'); 
...
$blog3->setBlog('Lorem ipsumvehicula nunc non leo hendrerit commodo. Vestibulum vulputate mau-ris eget erat congue dapibus imperdiet justo scelerisque.');
...
$comment14->setComment('Oh, come on, Stan. Not everything ends the way you think it should. Besi-des, audiences love happy endings.');
...
$blog4->setBlog('Lorem commodo. Vestibulum vulputate mauris eget erat congue dapibus imper-diet justo scelerisque. Nulla consectetur tempus nisl vitae viverra.');
...
$blog5->setBlog('Lorem ipsum dolor sit amet, consectetur adipiscing elittibulum vulputate mau-ris eget erat congue dapibus imperdiet justo scelerisque.');
